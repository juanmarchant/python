...
#     Nuestro script trabajará sobre un fichero contador.txt. Comprobaremos si el fichero no existe o está vacío, en ese caso lo crearemos con el número 0.
...
fichero = open('contador.txt', 'a+', encoding='utf8') # a+ Crea un fichero si no existe 
fichero.seek(0) #poscionamos el puntero en 0 
